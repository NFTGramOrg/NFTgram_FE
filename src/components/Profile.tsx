    ...
    <div className="p-4">
        <div className="relative flex w-full">
            <div className="flex flex-1">
                <div className="margin-top: -6rem;">
                    <div className="height:9rem width:9rem md rounded-full relative avatar">
                        <Image className="md rounded-full relative border-4 border-gray-900" src={profilepic} alt="" width={100} height={100}/>
